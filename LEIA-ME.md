# 🧠 PHC DOJO SENSEI — como usar (Escola ACME DO MUNDO 🏜️)

Transformei o guia teórico num **sistema de prática deliberada**. São 3 ficheiros:

| Ficheiro | O que é | Como usar |
|---|---|---|
| **Site (PWA)** | https://bfrpaulondev.github.io/phc-evolution-sensei/ — app completa: 57 missões, tutor IA, mascote Einstein, aulas guiadas ACME, cartas SRS, testes, provas. **Instale** pelo ícone ⊕ do navegador (funciona offline após a 1ª visita) | Abra o link, instale, treine. Progresso guardado no navegador — use ⚙️ → Exportar como backup |
...
## 🤖 Tutor IA & mascote (novo na v2.0)

- **Professor ACMEinstein** (mascote no canto inferior direito): pisca, fala (TTS pt-BR), dá dicas por aba. **Clique** nele para abrir o chat de IA.
- **🎓 Aula guiada**: em cada missão (e em cada capítulo da Teoria) o Professor explica cada parágrafo aplicado à **ACME DO MUNDO LTDA** — com avanço automático e voz.
