# 🧠 PHC DOJO SENSEI — como usar (Arena Starr Park 🏆 · Brawl Stars Edition)

Transformei o guia teórico num **sistema de prática deliberada**. São 3 ficheiros:

| Ficheiro | O que é | Como usar |
|---|---|---|
| **Site (PWA)** | https://bfrpaulondev.github.io/phc-evolution-sensei/ — app completa: 57 missões, tutor IA, mascote Einstein gamer, aulas guiadas Brawl, cartas SRS, testes por rank, provas. **Instale** pelo ícone ⊕ do navegador (funciona offline após a 1ª visita) | Abra o link, instale, treine. Progresso guardado no navegador — use ⚙️ → Exportar como backup |
...
- **Professor Brawleinstein** (mascote no canto inferior direito): pisca, fala (TTS pt-BR), dá dicas por aba. **Clique** nele para abrir o chat de IA.
