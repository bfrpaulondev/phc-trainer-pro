...
4. No Worker: **Settings → Variables and Secrets → Add**:
   ...
   - (Opcional) Type: Text · Name: `ALLOWED_ORIGINS` · Value: `https://bfrpaulondev.github.io` (lista separada por vírgulas; omissão = só este domínio).
...
- Alternativa 1-clique: abra `https://bfrpaulondev.github.io/phc-trainer-pro/#pxy=https://phc-ai-proxy.<subdomínio>.workers.dev`
...
curl -X POST https://phc-ai-proxy.<subdomínio>.workers.dev \
  -H 'Content-Type: application/json' -H 'Origin: https://bfrpaulondev.github.io' \
